...
echo"7.25 Zum Suchen und Ersetzen : "."</p>";
...
um addslashes() wieder Ruckgangig zu machen. Dabei werden Sonderzeichen wie \n ignoriert "."<br/>\n ";
echo "BSP 4 : "."<br/>\n ";
$string = "PHP's \string\ functions ";
